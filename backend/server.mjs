...
const routes = [
  ...
  route('GET', '/collateral-audios', ({ state, url }) => collateralAudios(state, { personId: url.searchParams.get('personId') })),
  ...
  route('POST', '/collateral-audios', ({ state, actor, payload }) => recordCollateralAudio(state, actor, payload)),
